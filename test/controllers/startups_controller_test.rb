...
class StartupsControllerTest < ActionController::TestCase
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post :create, startup: { description: @startup.description, name: @startup.name, no_votes: @startup.no_votes, photo: @startup.photo, startup_id: @startup.startup_id }
    end
  ...
  test "should update startup" do
    patch :update, id: @startup, startup: { description: @startup.description, name: @startup.name, no_votes: @startup.no_votes, photo: @startup.photo, startup_id: @startup.startup_id }
    assert_redirected_to startup_path(assigns(:startup))
  end
