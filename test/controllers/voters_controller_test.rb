...
class VotersControllerTest < ActionController::TestCase
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post :create, voter: { name: @voter.name, voter_id: @voter.voter_id, voter_type: @voter.voter_type }
    end
  ...
  test "should update voter" do
    patch :update, id: @voter, voter: { name: @voter.name, voter_id: @voter.voter_id, voter_type: @voter.voter_type }
    assert_redirected_to voter_path(assigns(:voter))
  end
